            ...
            if (/edit|delete/.test(op)) {
                ...
                if (op == "edit") {
                    ...
                    if (confirm('Are you sure you want to delete "'+ entry.first_name +' '+ entry.last_name +'" from your contacts?')) {
                        Contacts.storeDelete(entry);
                        Contacts.tableDelete(entry);
                    }
                }
                event.preventDefault();
            }
    ...
    tableEdit: function(entry) {
        ...
        $td = document.createElement("td");
        $td.innerHTML = '<a data-op="edit" data-id="'+ entry.id +'">Edit</a> | <a data-op="delete" data-id="'+ entry.id +'">Remove</a>';
        $tr.appendChild($td);
    },
    tableDelete: function(entry) {
